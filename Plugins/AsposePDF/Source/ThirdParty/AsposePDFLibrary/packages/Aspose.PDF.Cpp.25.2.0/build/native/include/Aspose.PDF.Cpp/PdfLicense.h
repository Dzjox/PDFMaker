...
/// </summary>
//[JavaManual("This was manually ported some time ago. Keep as is for now.")]//If 24.6 release ok - remove the line and remove the attribute from external
class ASPOSE_PDF_SHARED_CLASS License : public System::Object
{
...
public:
    ...
    /// </summary>
    ASPOSE_PDF_SHARED_API bool get_Embedded() const;
    /// @deprecated
    /// <summary>
    /// License number was added as embedded resource.
    /// </summary>
    ASPOSE_PDF_SHARED_API void set_Embedded(bool value);
    
    /// <summary>
    /// Initializes a new instance of this class.
    /// </summary>
    ASPOSE_PDF_SHARED_API License();
    ...
    ASPOSE_PDF_SHARED_API void SetLicense(System::String licenseName);
    /// <summary>
    /// Licenses the component.
    /// </summary>
    ...
    ASPOSE_PDF_SHARED_API void SetLicense(System::SharedPtr<System::IO::Stream> stream);
