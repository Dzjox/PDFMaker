...
class ASPOSE_PDF_SHARED_CLASS ExplicitDestinationTypeConverter : public System::Object
{
...
public:
    ...
    static ASPOSE_PDF_SHARED_API System::String ToString(ExplicitDestinationType value);
    static ASPOSE_PDF_SHARED_API ExplicitDestinationType ToEnum(System::String value);
