...
/// </summary>
class ASPOSE_PDF_SHARED_CLASS FitBExplicitDestination final : public Aspose::Pdf::Annotations::ExplicitDestination
{
...
public:
    ...
    ASPOSE_PDF_SHARED_API FitBExplicitDestination(System::SharedPtr<Aspose::Pdf::Page> page);
    ...
    ASPOSE_PDF_SHARED_API FitBExplicitDestination(System::SharedPtr<Document> document, int32_t pageNumber);
    /// <summary>
    /// Creates remote explicit destination.
    /// </summary>
    /// <param name="pageNumber">The destination page number of remote document.</param>
    ASPOSE_PDF_SHARED_API FitBExplicitDestination(int32_t pageNumber);
...
protected:
    ...
    MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(FitBExplicitDestination, CODEPORTING_ARGS(System::SharedPtr<Aspose::Pdf::Engine::Data::IPdfArray> engineDest));
