...
class ASPOSE_PDF_SHARED_CLASS PredefinedActionConverter : public System::Object
{
...
public:
    ...
    static ASPOSE_PDF_SHARED_API System::String ToString(PredefinedAction value);
