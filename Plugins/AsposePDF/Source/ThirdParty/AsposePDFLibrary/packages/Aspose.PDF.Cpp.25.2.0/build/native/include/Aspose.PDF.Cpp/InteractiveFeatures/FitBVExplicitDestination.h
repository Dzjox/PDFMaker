...
/// </summary>
class ASPOSE_PDF_SHARED_CLASS FitBVExplicitDestination final : public Aspose::Pdf::Annotations::ExplicitDestination
{
...
public:
    ...
    ASPOSE_PDF_SHARED_API FitBVExplicitDestination(System::SharedPtr<Aspose::Pdf::Page> page, double left);
    ...
    /// <param name="left">The horizontal coordinate left positioned at the left edge of the window.</param>
    ASPOSE_PDF_SHARED_API FitBVExplicitDestination(System::SharedPtr<Document> document, int32_t pageNumber, double left);
    /// <summary>
    /// Creates remote explicit destination.
    /// </summary>
    /// <param name="pageNumber">The destination page number of remote document.</param>
    /// <param name="left">The horizontal coordinate left positioned at the left edge of the window.</param>
    ASPOSE_PDF_SHARED_API FitBVExplicitDestination(int32_t pageNumber, double left);
...
protected:
    ...
    MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(FitBVExplicitDestination, CODEPORTING_ARGS(System::SharedPtr<Aspose::Pdf::Engine::Data::IPdfArray> engineDest));
