...
/// </summary>
class ASPOSE_PDF_SHARED_CLASS SquareAnnotation final : public Aspose::Pdf::Annotations::CommonFigureAnnotation
{
...
public:
    ...
    ASPOSE_PDF_SHARED_API SquareAnnotation(System::SharedPtr<Document> document);
    ...
    ASPOSE_PDF_SHARED_API SquareAnnotation(System::SharedPtr<Aspose::Pdf::Page> page, System::SharedPtr<Rectangle> rect);
...
protected:
    ...
    MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(SquareAnnotation, CODEPORTING_ARGS(System::SharedPtr<Aspose::Pdf::Engine::Data::IPdfObject> engineAnnot, System::SharedPtr<Document> document));
    ...
    virtual ASPOSE_PDF_SHARED_API ~SquareAnnotation();
