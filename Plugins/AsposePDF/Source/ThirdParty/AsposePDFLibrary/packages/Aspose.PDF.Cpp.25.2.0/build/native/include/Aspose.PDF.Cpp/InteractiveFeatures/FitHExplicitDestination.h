...
/// </summary>
class ASPOSE_PDF_SHARED_CLASS FitHExplicitDestination final : public Aspose::Pdf::Annotations::ExplicitDestination
{
...
public:
    ...
    ASPOSE_PDF_SHARED_API FitHExplicitDestination(System::SharedPtr<Aspose::Pdf::Page> page, double top);
    ...
    /// <param name="top">The vertical coordinate top positioned at the top edge of the window.</param>
    ASPOSE_PDF_SHARED_API FitHExplicitDestination(System::SharedPtr<Document> document, int32_t pageNumber, double top);
    /// <summary>
    /// Creates remote explicit destination.
    /// </summary>
    /// <param name="pageNumber">The destination page number of remote document.</param>
    /// <param name="top">The vertical coordinate top positioned at the top edge of the window.</param>
    ASPOSE_PDF_SHARED_API FitHExplicitDestination(int32_t pageNumber, double top);
...
protected:
    ...
    MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(FitHExplicitDestination, CODEPORTING_ARGS(System::SharedPtr<Aspose::Pdf::Engine::Data::IPdfArray> engineDest));
