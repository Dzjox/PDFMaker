...
enum class Permissions
{
    ...
    /// depending on whether <see cref="PrintingQuality"></see> is also set).
    /// </summary>
    PrintDocument = static_cast<int32_t>(static_cast<int32_t>(1 << 2)),
    /// <summary>
    /// Modify the contents of the document by operations other 
    /// than those controlled by  <see cref="ModifyTextAnnotations"></see>, 
    /// <see cref="FillForm"></see>, and 11.
    /// </summary>
    ...
    /// other than that controlled by <see cref="ExtractContentWithDisabilities"></see>.
    /// </summary>
    ExtractContent = static_cast<int32_t>(static_cast<int32_t>(1 << 4)),
    /// <summary>
    /// Add or modify text annotations, fill in interactive form fields, 
    /// and, if <see cref="ModifyContent"></see> is also set, create or modify interactive form 
    ...
    /// <see cref="ModifyTextAnnotations"></see> is clear.
    /// </summary>
    ...
    /// images), even if <see cref="ModifyContent"></see> is clear.
    /// </summary>
