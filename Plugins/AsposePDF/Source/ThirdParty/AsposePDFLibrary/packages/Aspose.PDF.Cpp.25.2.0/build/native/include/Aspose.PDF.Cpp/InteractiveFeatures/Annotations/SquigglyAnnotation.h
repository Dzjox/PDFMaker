...
/// </summary>
class ASPOSE_PDF_SHARED_CLASS SquigglyAnnotation final : public Aspose::Pdf::Annotations::TextMarkupAnnotation
{
...
public:
    ...
    ASPOSE_PDF_SHARED_API SquigglyAnnotation(System::SharedPtr<Aspose::Pdf::Page> page, System::SharedPtr<Rectangle> rect);
...
protected:
    ...
    MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(SquigglyAnnotation, CODEPORTING_ARGS(System::SharedPtr<Aspose::Pdf::Engine::Data::IPdfObject> engineAnnot, System::SharedPtr<Document> document));
    
    virtual ASPOSE_PDF_SHARED_API ~SquigglyAnnotation();
