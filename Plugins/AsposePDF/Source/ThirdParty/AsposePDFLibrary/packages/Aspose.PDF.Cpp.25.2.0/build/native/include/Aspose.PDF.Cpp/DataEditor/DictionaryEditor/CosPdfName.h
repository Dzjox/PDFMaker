...
/// </summary>
class ASPOSE_PDF_SHARED_CLASS CosPdfName final : public Aspose::Pdf::DataEditor::CosPdfPrimitive
{
    typedef CosPdfName ThisType;
...
public:
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CosPdfName"></see> class.
    /// </summary>
    /// <param name="value">The name.</param>
    ASPOSE_PDF_SHARED_API CosPdfName(System::String value);
    ...
    /// <summary>
    /// Returns a <see cref="System::String"></see> that represents the current <see cref="CosPdfName"></see>.
    /// </summary>
    /// <returns>A <see cref="System::String"></see> that represents the current <see cref="CosPdfName"></see>.</returns>
...
protected:
    ...
    virtual ASPOSE_PDF_SHARED_API ~CosPdfName();
    
private:

    static const System::String Prefix;
