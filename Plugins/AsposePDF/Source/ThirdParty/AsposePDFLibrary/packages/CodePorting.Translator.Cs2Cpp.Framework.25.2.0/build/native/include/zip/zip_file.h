...
public:
    ...
    static ASPOSECPP_SHARED_API System::SharedPtr<ZipFile> Read(const System::SharedPtr<System::IO::Stream>& zipStream, bool enableRecoveryMode);
    ...
    ASPOSECPP_SHARED_API System::Details::VirtualizedIteratorBase<System::SharedPtr<ZipEntry>>* virtualizeBeginIterator() override;
    ASPOSECPP_SHARED_API System::Details::VirtualizedIteratorBase<System::SharedPtr<ZipEntry>>* virtualizeEndIterator() override;
    ASPOSECPP_SHARED_API System::Details::VirtualizedIteratorBase<System::SharedPtr<ZipEntry>>* virtualizeBeginConstIterator() const override;
    ASPOSECPP_SHARED_API System::Details::VirtualizedIteratorBase<System::SharedPtr<ZipEntry>>* virtualizeEndConstIterator() const override;

protected:
    /// Destructor.
    ASPOSECPP_SHARED_API ~ZipFile() override;
