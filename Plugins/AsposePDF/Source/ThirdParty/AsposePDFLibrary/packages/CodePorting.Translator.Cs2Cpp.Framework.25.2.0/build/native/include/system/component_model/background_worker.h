...
public:
    ...
    ASPOSECPP_SHARED_API void RunWorkerAsync(const System::SharedPtr<System::Object>& argument);
    ...
    ASPOSECPP_SHARED_API void ReportProgress(int percentProgress, const System::SharedPtr<System::Object>& userState);
...
private:
    ...
    bool m_IsBusy;
    System::SharedPtr<System::Threading::Thread> m_thread;
};
