...
public:
    ...
    ASPOSECPP_SHARED_API void set_KeepCrcStreamPos(bool value);
    ...
    /// </summary>
    ASPOSECPP_SHARED_API System::SharedPtr<System::IO::Stream> GetCompressedStream();

    /// <summary>
    /// Returns a copy of entry compressed data.
    /// </summary>
    ASPOSECPP_SHARED_API System::SharedPtr<System::Array<uint8_t>> GetCompressedBytes();

protected:
    /// Destructor.
    ASPOSECPP_SHARED_API ~ZipEntry() override;
...
private:
    ...
    /// </remarks>
    int16_t get_CompressionFlags() const;
