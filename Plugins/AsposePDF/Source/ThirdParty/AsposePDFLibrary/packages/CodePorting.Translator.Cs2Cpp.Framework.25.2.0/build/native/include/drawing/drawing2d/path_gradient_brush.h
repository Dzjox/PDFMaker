...
private:
    ...
    /// Calculate gradient colors from gradient factor values.
    void CalculateGradientColors() const;
...
private:
    ...
    /// Colors at the corresponding points of the path.
    ArrayPtr<Color> m_surround_colors;

    /// Gradient colors.
    mutable std::vector<SkColor> m_colors;
