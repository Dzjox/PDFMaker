...
namespace System
{
    ...
    public:
        ...
        public:
            ...
            /// @returns True if the current element's index did not point to the last element in the array before it was advanced, otherwise - false
        ...
        /// Constructs an Array object and fills it with values from the specified array containing elements of @p UnderlyingType type.
        /// @param init Array to copy into the array being constructed.
        /// @tparam InitArraySize Number of elements of the @p init array.
...
public:
        ...
        /// Copies all elements of the current array to the specified destination array. Elements are inserted
...
public:
        ...
        /// Clones the array.
        /// @returns A pointer to a new array object containing items that are copies of items of the array represented
        ...
        /// @param converter A Converter object used to convert each element of the input array to equivalent values of @p OutputType type
        ...
        /// @param input_array An Array object
        /// @param converter A function object used to convert each element of the input array to equivalent values of @p OutputType type
        /// @returns A new array containing values of @p OutputType type equivalent to the values of @p input_array
        /// @tparam InputType The type of elements of input array
        /// @tparam OutputType The type of elements of the resulting array
        template <typename InputType, typename OutputType>
        ...
        /// @returns The index of the first element in the array that satisfies the conditions defined by predicate, otherwise -1
        ...
        /// Copies all elements of the current array to the specified destination array view. Elements are inserted
        /// into the destination array view starting at index specified by dstIndex argument.
        ...
        /// @returns Index of the first occurrence specified item if the item is found, otherwise -1
        ...
        /// @param startIndex Index at which the search is started
        /// @param count Number of elements of the range to search in
        /// @returns Index of the last occurrence of the specified item if the item is found, otherwise -1
        /// @tparam ArrayType Type of elements in the target array
        /// @tparam ValueType type of the item to search for in the array
        template<typename ArrayType, typename ValueType>
        ...
        /// Replaces @p count values starting at the @p startIndex index in the specified array with default values.
        /// @param arr Target array
        ...
        /// @param srcArray Source array view
        /// @param dstArray Destination array
        /// @param count The number of elements to copy
        template<typename SrcType, typename DstType>
        ...
        /// @param srcArray Source array on stack
        /// @param dstArray Destination array
        /// @param count The number of elements to copy
        ...
        /// @param srcArray Source array
        /// @param dstArray Destination array on stack
        /// @param count The number of elements to copy
        ...
        /// @param srcArray Source array view
        /// @param srcIndex Index in the source array view designating the beginning of the range of items to copy
        /// @param dstArray Destination array
        /// @param dstIndex Index in destination array to start inserting copied items at
        /// @param count The number of elements to copy
        /// @tparam SrcType Type of elements in source array view
        /// @tparam DstType Type of elements in destination array
        template<typename SrcType, typename DstType>
        ...
        /// @param srcArray Source array on stack
        /// @param srcIndex Index in the source array on stack designating the beginning of the range of items to copy
        /// @param dstArray Destination array
        /// @param dstIndex Index in destination array to start inserting copied items at
        /// @param count The number of elements to copy
        /// @tparam SrcType Type of elements in source array on stack
        /// @tparam DstType Type of elements in destination array
        template<typename SrcType, std::size_t N, typename DstType>
        ...
        /// @param srcIndex Index in the source array designating the beginning of the range of items to copy
        /// @param dstArray Destination array on stack
        /// @param dstIndex Index in destination array on stack to start inserting copied items at
        /// @param count The number of elements to copy
        /// @tparam SrcType Type of elements in source array
        /// @tparam DstType Type of elements in destination array on stack
        template<typename SrcType, typename DstType, std::size_t N>
        static void Copy(const ArrayPtr<SrcType> &srcArray, int64_t srcIndex,
        ...
        /// Sorts two arrays one containing keys and the other - corresponding items, based on the values of array containing keys, elements of which
        ...
        /// @param keys Array that contains key values
        /// @param items Array that contains items that are mapped to the key values in @p keys array 
        /// @param index The index designating the beginning of the range to sort
        ...
        /// @param value A const reference to the value to set
...
private:
        ...
        /// @param dim The number of dimension of the array to determining the bound of
        /// @returns The upper bound of the specified dimension of the specified array
        ...
        /// Returns the number of elements of multi-dimensional array represented by
        ...
        /// @tparam Alloc1 The type of the allocator used by std::vector objects that are elements of the std::vector object accepted by the method as an argument
...
protected:
    ...
    /// @cond
    /// Makes sure that conversion (ExplicitCast, AsCast, etc.) to array pointer return ArrayPtr, not naked SmartPtr.
