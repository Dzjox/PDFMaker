...
/// </summary>
class ASPOSE_SLIDES_API_SHARED_CLASS ILeftRightDirectionTransition : public virtual Aspose::Slides::SlideShow::ITransitionValueBase
{
    typedef ILeftRightDirectionTransition ThisType;
