...
/// </summary>
class ASPOSE_SLIDES_API_SHARED_CLASS IFormat : public virtual System::Object
{
    typedef IFormat ThisType;
...
public:
    ...
    /// </summary>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IThreeDFormat> get_Effect3D() = 0;
