...
/// </summary>
class ASPOSE_SLIDES_API_SHARED_CLASS IVideo : public virtual System::Object
{
    typedef IVideo ThisType;
...
public:
    ...
    /// <summary>
    /// Returns a MIME type of an video, encoded in <see cref="IVideo::get_BinaryData"></see>.
    ...
    /// <see cref="IVideo::GetStream"></see> method to prevent unnecessary loading of video's data into memory 
