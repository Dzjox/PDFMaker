...
/// </summary>
class ASPOSE_SLIDES_API_SHARED_CLASS IConnectorLock : public virtual Aspose::Slides::IBaseShapeLock
{
    typedef IConnectorLock ThisType;
...
public:
    ...
    /// Read <see cref="bool"></see>.
    /// </summary>
    virtual ASPOSE_SLIDES_API_LOCAL_API bool get_PositionMove() = 0;
    /// <summary>
    /// Determines whether a moving this shape is forbidden.
    /// Write <see cref="bool"></see>.
    /// </summary>
    virtual ASPOSE_SLIDES_API_LOCAL_API void set_PositionMove(bool value) = 0;
    /// <summary>
