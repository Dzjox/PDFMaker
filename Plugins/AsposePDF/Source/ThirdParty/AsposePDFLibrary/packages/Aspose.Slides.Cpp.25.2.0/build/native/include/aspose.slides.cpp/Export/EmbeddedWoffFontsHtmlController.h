...
#include <DOM/IEmbeddedWoffFontsHtmlController.h>
...
/// </summary>
class ASPOSE_SLIDES_SHARED_CLASS EmbeddedWoffFontsHtmlController : public Aspose::Slides::Export::IEmbeddedWoffFontsHtmlController
{
    typedef EmbeddedWoffFontsHtmlController ThisType;
    typedef Aspose::Slides::Export::IEmbeddedWoffFontsHtmlController BaseType;
...
public:
    ...
    /// </summary>
    ASPOSE_SLIDES_SHARED_API EmbeddedWoffFontsHtmlController();
    /// <summary>
    /// Creates new instance.
    /// </summary>
    /// <param name="controller">HTML formatting controller.</param>
    ASPOSE_SLIDES_SHARED_API EmbeddedWoffFontsHtmlController(System::SharedPtr<IHtmlFormattingController> controller);
