...
/// </summary>
class ASPOSE_SLIDES_API_SHARED_CLASS IPresetShadow : public virtual Aspose::Slides::Effects::IImageTransformOperation, public Aspose::Slides::IAccessiblePVIObject<System::SharedPtr<Aspose::Slides::Effects::IPresetShadowEffectiveData>>
{
    typedef IPresetShadow ThisType;
    typedef Aspose::Slides::Effects::IImageTransformOperation BaseType;
    typedef Aspose::Slides::IAccessiblePVIObject<System::SharedPtr<Aspose::Slides::Effects::IPresetShadowEffectiveData>> BaseType1;
...
public:
    ...
    /// </summary>
    virtual ASPOSE_SLIDES_API_LOCAL_API void set_Preset(PresetShadowType value) = 0;
