...
/// </summary>
class ASPOSE_SLIDES_SHARED_CLASS PictureFrameLock : public Aspose::Slides::BaseShapeLock, public Aspose::Slides::IPictureFrameLock
{
    typedef PictureFrameLock ThisType;
    typedef Aspose::Slides::BaseShapeLock BaseType;
    typedef Aspose::Slides::IPictureFrameLock BaseType1;
...
public:
    ...
    /// Read <see cref="bool"></see>.
    /// </summary>
    ASPOSE_SLIDES_SHARED_API bool get_CropLocked() override;
    /// <summary>
    /// Determines whether an image cropping is forbidden.
    /// Write <see cref="bool"></see>.
    /// </summary>
    ASPOSE_SLIDES_SHARED_API void set_CropLocked(bool value) override;
    
protected:

    /// @cond
    ASPOSE_SLIDES_LOCAL_API PictureFrameLock();
    /// @endcond
    
    ASPOSE_SLIDES_LOCAL_API MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(PictureFrameLock, CODEPORTING_ARGS());
