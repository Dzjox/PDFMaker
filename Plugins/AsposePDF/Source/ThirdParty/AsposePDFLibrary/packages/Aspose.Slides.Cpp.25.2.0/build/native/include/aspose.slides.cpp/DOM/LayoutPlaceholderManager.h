...
/// </summary>
class ASPOSE_SLIDES_SHARED_CLASS LayoutPlaceholderManager : public Aspose::Slides::ILayoutPlaceholderManager
{
    typedef LayoutPlaceholderManager ThisType;
    typedef Aspose::Slides::ILayoutPlaceholderManager BaseType;
...
public:
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddContentPlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddVerticalContentPlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddTextPlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddVerticalTextPlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddPicturePlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddChartPlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddTablePlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddSmartArtPlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddMediaPlaceholder(float x, float y, float width, float height) override;
    /// <summary>
    ...
    /// </code>
    /// </example>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<IAutoShape> AddOnlineImagePlaceholder(float x, float y, float width, float height) override;
    
protected:

    /// @cond
    ASPOSE_SLIDES_LOCAL_API LayoutPlaceholderManager(System::SharedPtr<LayoutSlide> layoutSlide);
    /// @endcond
    
    ASPOSE_SLIDES_LOCAL_API MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(LayoutPlaceholderManager, CODEPORTING_ARGS(System::SharedPtr<LayoutSlide> layoutSlide));
    
private:

    System::WeakPtr<LayoutSlide> m_layoutSlide;
    
    ASPOSE_SLIDES_LOCAL_API System::SharedPtr<AutoShape> AddPlaceholderShape(float x, float y, float width, float height, System::String name, Orientation orientation, PlaceholderType type);
    ASPOSE_SLIDES_LOCAL_API void FillBodyText(System::SharedPtr<TextFrame> textFrame, System::String textLang, Orientation orientation);
    ASPOSE_SLIDES_LOCAL_API System::SharedPtr<Paragraph> CreateBodyParagraph(int16_t depth, System::String textLang, System::String text);
