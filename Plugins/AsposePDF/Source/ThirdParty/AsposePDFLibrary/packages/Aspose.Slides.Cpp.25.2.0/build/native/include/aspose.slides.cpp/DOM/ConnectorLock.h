...
/// </summary>
class ASPOSE_SLIDES_SHARED_CLASS ConnectorLock : public Aspose::Slides::BaseShapeLock, public Aspose::Slides::IConnectorLock
{
    typedef ConnectorLock ThisType;
    typedef Aspose::Slides::BaseShapeLock BaseType;
    typedef Aspose::Slides::IConnectorLock BaseType1;
...
public:
    ...
    /// Read <see cref="bool"></see>.
    /// </summary>
    ASPOSE_SLIDES_SHARED_API bool get_PositionMove() override;
    /// <summary>
    /// Determines whether a moving this shape is forbidden.
    /// Write <see cref="bool"></see>.
    /// </summary>
    ASPOSE_SLIDES_SHARED_API void set_PositionMove(bool value) override;
    /// <summary>
...
protected:
    ...
    /// @cond
    ASPOSE_SLIDES_LOCAL_API ConnectorLock();
    /// @endcond
    
    ASPOSE_SLIDES_LOCAL_API MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(ConnectorLock, CODEPORTING_ARGS());
