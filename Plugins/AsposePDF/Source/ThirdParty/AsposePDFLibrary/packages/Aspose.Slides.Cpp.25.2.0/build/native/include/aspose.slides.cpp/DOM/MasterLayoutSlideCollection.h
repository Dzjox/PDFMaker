...
/// </summary>
class ASPOSE_SLIDES_SHARED_CLASS MasterLayoutSlideCollection final : public Aspose::Slides::LayoutSlideCollection, public Aspose::Slides::IMasterLayoutSlideCollection
{
    typedef MasterLayoutSlideCollection ThisType;
    typedef Aspose::Slides::LayoutSlideCollection BaseType;
    typedef Aspose::Slides::IMasterLayoutSlideCollection BaseType1;
...
public:
    ...
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<ILayoutSlide> InsertClone(int32_t index, System::SharedPtr<ILayoutSlide> sourceLayout) override;
    /// <summary>
    ...
    /// </remarks>
    /// <returns>Added slide.</returns>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<ILayoutSlide> Add(SlideLayoutType layoutType, System::String layoutName) override;
    /// <summary>
    ...
    /// </remarks>
    /// <returns>Inserted slide.</returns>
    ASPOSE_SLIDES_SHARED_API System::SharedPtr<ILayoutSlide> Insert(int32_t index, SlideLayoutType layoutType, System::String layoutName) override;
    /// <summary>
    ...
    ASPOSE_SLIDES_SHARED_API void Reorder(int32_t index, System::SharedPtr<ILayoutSlide> layoutSlide) override;
    
protected:

    /// @cond
    ASPOSE_SLIDES_LOCAL_API MasterLayoutSlideCollection(System::SharedPtr<MasterSlide> parentImmediate);
    /// @endcond
    
    ASPOSE_SLIDES_LOCAL_API MEMBER_FUNCTION_MAKE_OBJECT_DECLARATION(MasterLayoutSlideCollection, CODEPORTING_ARGS(System::SharedPtr<MasterSlide> parentImmediate));
    ASPOSE_SLIDES_SHARED_API void Add(System::SharedPtr<ILayoutSlide> value) override;
    
    virtual ASPOSE_SLIDES_SHARED_API ~MasterLayoutSlideCollection();
