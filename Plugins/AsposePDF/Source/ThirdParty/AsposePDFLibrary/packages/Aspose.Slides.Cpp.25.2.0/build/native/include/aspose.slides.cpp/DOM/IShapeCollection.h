...
/// </summary>
class ASPOSE_SLIDES_API_SHARED_CLASS IShapeCollection : public Aspose::Slides::IGenericCollection<System::SharedPtr<Aspose::Slides::IShape>>
{
    typedef IShapeCollection ThisType;
    typedef Aspose::Slides::IGenericCollection<System::SharedPtr<Aspose::Slides::IShape>> BaseType;
...
public:
    ...
    /// </summary>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IShape> idx_get(int32_t index) = 0;
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<Charts::IChart> AddChart(Charts::ChartType type, float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// </param>
    /// <returns>Created chart.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<Charts::IChart> AddChart(Charts::ChartType type, float x, float y, float width, float height, bool initWithSample) = 0;
    /// <summary>
    ...
    /// </code>
    /// </example>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<SmartArt::ISmartArt> AddSmartArt(float x, float y, float width, float height, SmartArt::SmartArtLayoutType layoutType) = 0;
    /// <summary>
    ...
    /// <returns>Created chart.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<Charts::IChart> InsertChart(Charts::ChartType type, float x, float y, float width, float height, int32_t index) = 0;
    /// <summary>
    ...
    /// </param>
    /// <returns>Created chart.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<Charts::IChart> InsertChart(Charts::ChartType type, float x, float y, float width, float height, int32_t index, bool initWithSample) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IOleObjectFrame> AddOleObjectFrame(float x, float y, float width, float height, System::SharedPtr<IOleEmbeddedDataInfo> dataInfo) = 0;
    /// <summary>
    /// Adds a new OLE object to the end of a collection.
    /// </summary>
    /// <param name="x">X coordinate of a new OLE frame.</param>
    ...
    /// <returns>Created OLE object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IOleObjectFrame> AddOleObjectFrame(float x, float y, float width, float height, System::String className, System::String path) = 0;
    /// <summary>
    ...
    /// <param name="dataInfo">Embedded data info <see cref="Aspose::Slides::IOleEmbeddedDataInfo">IOleEmbeddedDataInfo</see>.</param>
    /// <returns>Created OLE object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IOleObjectFrame> InsertOleObjectFrame(int32_t index, float x, float y, float width, float height, System::SharedPtr<IOleEmbeddedDataInfo> dataInfo) = 0;
    /// <summary>
    /// Creates a new OLE object and inserts it to a collection at the specified index.
    /// </summary>
    /// <param name="index">The zero-based index at which OLE object should be inserted.</param>
    ...
    /// <param name="path">Path to the linked file.</param>
    /// <returns>Created OLE object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IOleObjectFrame> InsertOleObjectFrame(int32_t index, float x, float y, float width, float height, System::String className, System::String path) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IZoomFrame> AddZoomFrame(float x, float y, float width, float height, System::SharedPtr<ISlide> slide) = 0;
    /// <summary>
    /// Adds a new Zoom object to the end of a collection.
    /// </summary>
    /// <example>
    ...
    /// <returns>Created Zoom object <see cref="Aspose::Slides::IZoomFrame">IZoomFrame</see>.</returns>
    /// <exception cref="System::ArgumentException ">Referenced slide does not belong to the current presentation.</exception>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IZoomFrame> AddZoomFrame(float x, float y, float width, float height, System::SharedPtr<ISlide> slide, System::SharedPtr<IPPImage> image) = 0;
    /// <summary>
    ...
    /// <returns>Created Zoom object <see cref="Aspose::Slides::IZoomFrame">IZoomFrame</see>.</returns>
    /// <exception cref="System::ArgumentException ">Referenced slide does not belong to the current presentation.</exception>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IZoomFrame> InsertZoomFrame(int32_t index, float x, float y, float width, float height, System::SharedPtr<ISlide> slide) = 0;
    /// <summary>
    /// Creates a new Zoom object and inserts it to a collection at the specified index.
    /// </summary>
    /// <example>
    ...
    /// <returns>Created Zoom object <see cref="Aspose::Slides::IZoomFrame">IZoomFrame</see>.</returns>
    /// <exception cref="System::ArgumentException ">Referenced slide does not belong to the current presentation.</exception>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IZoomFrame> InsertZoomFrame(int32_t index, float x, float y, float width, float height, System::SharedPtr<ISlide> slide, System::SharedPtr<IPPImage> image) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<ISectionZoomFrame> AddSectionZoomFrame(float x, float y, float width, float height, System::SharedPtr<ISection> section) = 0;
    /// <summary>
    ...
    /// <returns>Created Section Zoom object <see cref="Aspose::Slides::ISectionZoomFrame">ISectionZoomFrame</see>.</returns>
    /// <exception cref="System::ArgumentException ">Referenced section does not belong to the current presentation or does not contains any slides.</exception>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<ISectionZoomFrame> AddSectionZoomFrame(float x, float y, float width, float height, System::SharedPtr<ISection> section, System::SharedPtr<IPPImage> image) = 0;
    /// <summary>
    ...
    /// <returns>Created Section Zoom object <see cref="Aspose::Slides::ISectionZoomFrame">ISectionZoomFrame</see>.</returns>
    /// <exception cref="System::ArgumentException ">Referenced section does not belong to the current presentation or does not contains any slides.</exception>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<ISectionZoomFrame> InsertSectionZoomFrame(int32_t index, float x, float y, float width, float height, System::SharedPtr<ISection> section) = 0;
    /// <summary>
    ...
    /// <returns>Created Section Zoom object <see cref="Aspose::Slides::ISectionZoomFrame">ISectionZoomFrame</see>.</returns>
    /// <exception cref="System::ArgumentException ">Referenced section does not belong to the current presentation or does not contains any slides.</exception>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<ISectionZoomFrame> InsertSectionZoomFrame(int32_t index, float x, float y, float width, float height, System::SharedPtr<ISection> section, System::SharedPtr<IPPImage> image) = 0;
    /// <summary>
    ...
    /// <exception cref="Aspose::Slides::PptxEditException">There are no sections in the presentation, or the target slide does not belong to any section.</exception>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<ISummaryZoomFrame> AddSummaryZoomFrame(float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// <returns>Created Summary Zoom object <see cref="Aspose::Slides::ISummaryZoomFrame">ISummaryZoomFrame</see>.</returns>
    /// <exception cref="Aspose::Slides::PptxEditException">There are no sections in the presentation, or the target slide does not belong to any section.</exception>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<ISummaryZoomFrame> InsertSummaryZoomFrame(int32_t index, float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IVideoFrame> AddVideoFrame(float x, float y, float width, float height, System::String fname) = 0;
    /// <summary>
    /// Adds a new video frame to the end of a collection.
    /// </summary>
    /// <param name="x">X coordinate of a new video frame.</param>
    ...
    /// <returns>Created VideoFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IVideoFrame> AddVideoFrame(float x, float y, float width, float height, System::SharedPtr<IVideo> video) = 0;
    /// <summary>
    ...
    /// <param name="fname">Video file name.</param>
    /// <returns>Created VideoFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IVideoFrame> InsertVideoFrame(int32_t index, float x, float y, float width, float height, System::String fname) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAudioFrame> AddAudioFrameCD(float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// <param name="height">Height of a new audio frame.</param>
    /// <returns>Created AudioFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAudioFrame> InsertAudioFrameCD(int32_t index, float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// <returns>Created AudioFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAudioFrame> AddAudioFrameLinked(float x, float y, float width, float height, System::String fname) = 0;
    /// <summary>
    ...
    /// <param name="fname">Audio file name.</param>
    /// <returns>Created AudioFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAudioFrame> InsertAudioFrameLinked(int32_t index, float x, float y, float width, float height, System::String fname) = 0;
    /// <summary>
    ...
    /// <returns>Created AudioFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAudioFrame> AddAudioFrameEmbedded(float x, float y, float width, float height, System::SharedPtr<System::IO::Stream> audio_stream) = 0;
    /// <summary>
    /// Adds a new audio frame with embedded audio file to the end of a collection.
    ...
    /// <returns>Created AudioFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAudioFrame> AddAudioFrameEmbedded(float x, float y, float width, float height, System::SharedPtr<IAudio> audio) = 0;
    /// <summary>
    ...
    /// <returns>Created AudioFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAudioFrame> InsertAudioFrameEmbedded(int32_t index, float x, float y, float width, float height, System::SharedPtr<System::IO::Stream> audio_stream) = 0;
    /// <summary>
    /// Insert an AudioFrame with embedded audio file.
    /// It uses audio file from Presentation.Audios list.
    /// </summary>
    ...
    /// <param name="audio">Audio from Presentation.Audios list.</param>
    /// <returns>Created AudioFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAudioFrame> InsertAudioFrameEmbedded(int32_t index, float x, float y, float width, float height, System::SharedPtr<IAudio> audio) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API int32_t IndexOf(System::SharedPtr<IShape> shape) = 0;
    /// <summary>
    /// Creates and returns an array with all shapse in it.
    /// </summary>
    /// <returns>Array of <see cref="Aspose::Slides::IShape">IShape</see></returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::ArrayPtr<System::SharedPtr<IShape>> ToArray() = 0;
    /// <summary>
    ...
    /// <returns>Array of <see cref="Aspose::Slides::IShape">IShape</see></returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::ArrayPtr<System::SharedPtr<IShape>> ToArray(int32_t startIndex, int32_t count) = 0;
    /// <summary>
    /// Moves a shape from the collection to the specified position.
    /// </summary>
    /// <param name="index">Target index.</param>
    /// <param name="shape">Shape to move.</param>
    virtual ASPOSE_SLIDES_API_LOCAL_API void Reorder(int32_t index, System::SharedPtr<IShape> shape) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API void Reorder(int32_t index, const System::ArrayPtr<System::SharedPtr<IShape>>& shapes) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAutoShape> AddAutoShape(ShapeType shapeType, float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// </param>
    /// <returns>Created AutoShape object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAutoShape> AddAutoShape(ShapeType shapeType, float x, float y, float width, float height, bool createFromTemplate) = 0;
    /// <summary>
    ...
    /// <param name="height">The height of shape's frame.</param>
    /// <returns>Created AutoShape object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAutoShape> AddMathShape(float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// <param name="height">The height of shape's frame.</param>
    /// <returns>Created AutoShape object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAutoShape> InsertAutoShape(int32_t index, ShapeType shapeType, float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// </param>
    /// <returns>Created AutoShape object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IAutoShape> InsertAutoShape(int32_t index, ShapeType shapeType, float x, float y, float width, float height, bool createFromTemplate) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IGroupShape> AddGroupShape() = 0;
    /// <summary>
    ...
    /// <returns>Created GroupShape object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IGroupShape> AddGroupShape(System::SharedPtr<ISvgImage> svgImage, float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// <param name="index">The zero-based index at which value should be inserted.</param>
    /// <returns>Created GroupShape object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IGroupShape> InsertGroupShape(int32_t index) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IConnector> AddConnector(ShapeType shapeType, float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// <returns>The zero-based index of the created shape.</returns>
    /// <returns>Created Connector object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IConnector> AddConnector(ShapeType shapeType, float x, float y, float width, float height, bool createFromTemplate) = 0;
    /// <summary>
    ...
    /// <param name="height">The height of shape's frame.</param>
    /// <returns>Created Connector object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IConnector> InsertConnector(int32_t index, ShapeType shapeType, float x, float y, float width, float height) = 0;
    /// <summary>
    ...
    /// </param>
    /// <returns>Created Connector object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IConnector> InsertConnector(int32_t index, ShapeType shapeType, float x, float y, float width, float height, bool createFromTemplate) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IPictureFrame> AddPictureFrame(ShapeType shapeType, float x, float y, float width, float height, System::SharedPtr<IPPImage> image) = 0;
    /// <summary>
    ...
    /// <param name="image">The image of picture frame.</param>
    /// <returns>Created PictureFrame object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IPictureFrame> InsertPictureFrame(int32_t index, ShapeType shapeType, float x, float y, float width, float height, System::SharedPtr<IPPImage> image) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<ITable> AddTable(float x, float y, System::ArrayPtr<double> columnWidths, System::ArrayPtr<double> rowHeights) = 0;
    /// <summary>
    ...
    /// <param name="rowHeights">Array of doubles which represents heights of rows in the table.</param>
    /// <returns>Created Table object.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<ITable> InsertTable(int32_t index, float x, float y, System::ArrayPtr<double> columnWidths, System::ArrayPtr<double> rowHeights) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API void Remove(System::SharedPtr<IShape> shape) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IShape> AddClone(System::SharedPtr<IShape> sourceShape, float x, float y, float width, float height) = 0;
    /// <summary>
    /// Adds a copy of a specified shape to the end of the collection.
    ...
    /// <param name="y">Y coordinate of a new shape.</param>
    /// <returns>New shape.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IShape> AddClone(System::SharedPtr<IShape> sourceShape, float x, float y) = 0;
    /// <summary>
    /// Adds a copy of a specified shape to the end of the collection.
    ...
    /// <param name="sourceShape">Shape to clone.</param>
    /// <returns>New shape.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IShape> AddClone(System::SharedPtr<IShape> sourceShape) = 0;
    /// <summary>
    ...
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IShape> InsertClone(int32_t index, System::SharedPtr<IShape> sourceShape, float x, float y, float width, float height) = 0;
    /// <summary>
    /// Inserts a copy of a specified shape to specified position of the collection.
    /// Width and Height of the new shape are equal to Width and Height of the <paramref name="sourceShape"></paramref>.
    /// </summary>
    ...
    /// <param name="y">Y coordinate of a new shape.</param>
    /// <returns>Inserted shape.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IShape> InsertClone(int32_t index, System::SharedPtr<IShape> sourceShape, float x, float y) = 0;
    /// <summary>
    /// Inserts a copy of a specified shape to specified position of the collection.
    /// X, Y, Width and Height of the new shape are equal to X, Y, Width and Height of the <paramref name="sourceShape"></paramref>.
    /// </summary>
    ...
    /// <param name="sourceShape">Shape to clone.</param>
    /// <returns>Inserted shape.</returns>
    virtual ASPOSE_SLIDES_API_LOCAL_API System::SharedPtr<IShape> InsertClone(int32_t index, System::SharedPtr<IShape> sourceShape) = 0;
