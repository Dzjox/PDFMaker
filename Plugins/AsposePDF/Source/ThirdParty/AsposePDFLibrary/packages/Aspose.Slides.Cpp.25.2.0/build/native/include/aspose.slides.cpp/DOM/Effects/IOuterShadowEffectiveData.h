...
/// </summary>
class ASPOSE_SLIDES_API_SHARED_CLASS IOuterShadowEffectiveData : public virtual Aspose::Slides::Effects::IEffectEffectiveData
{
    typedef IOuterShadowEffectiveData ThisType;
